...
Source0  : https://cpan.metacpan.org/authors/id/H/HA/HAARG/local-lib-2.000028.tar.gz
...
%prep
%setup -q -n local-lib-2.000028
cd %{_builddir}
tar xf %{_sourcedir}/liblocal-lib-perl_2.000024-1.debian.tar.xz
cd %{_builddir}/local-lib-2.000028
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/local-lib-2.000028/deblicense/
...
cp %{_builddir}/local-lib-2.000028/LICENSE %{buildroot}/usr/share/package-licenses/perl-local-lib/7696b9f77cfb3794bd4a985b4ce7f623175c9af9
if test -f Makefile.PL; then
